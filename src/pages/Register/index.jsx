                    ...
                    <div className="auth-quote">
                        <blockquote>
                            <p className="quote-text">
                                "Join thousands of Cyber Guardians protecting India from digital frauds. Together, we make the internet safer."
                            </p>
                            <footer className="quote-author">~ Community Hero</footer>
                        </blockquote>
                    </div>
                </div>
            ...
            <div className="auth-content">
                ...
                <div className="auth-form-container">
                    ...
                    <div className="auth-header">
                        ...
                        <p>Join SentinelX and become a Cyber Guardian today</p>
                    </div>
